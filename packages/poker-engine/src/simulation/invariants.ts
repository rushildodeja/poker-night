...
/**
 * Verifies conservation and structural invariants after every simulation action.
 * These checks are intentionally independent from PokerTable's internal methods.
 */
